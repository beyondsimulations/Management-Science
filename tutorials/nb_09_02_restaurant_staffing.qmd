...
You have **multiple competing objectives**. You need more experienced servers than available, shifts have different lengths affecting labor costs, and servers have varying preferences for different shifts. Your job is to find the best compromise:
...
print(f"  Experience Penalties: €{greedy_breakdown['penalty_cost']:.2f}")
print(f"  Preference Penalties: €{greedy_breakdown.get('preference_penalty', 0):.2f}")
...
2. **Think Strategically**
   ...
   - Saturday Dinner: 6 hours + €1200 penalty - needs your best experienced servers
