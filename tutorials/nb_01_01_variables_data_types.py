...
# >   precision. For example, floats can represent decimal numbers, while
# >   integers cannot.
...
# - If they pay with exact change, how many dollars (`dollars`) and cents
#   (`cents`) each person needs. Provide each as variable.
#
# > **Tip**
# >
...
# - Python has different data types (int, float, str) for different kinds
#   of information
