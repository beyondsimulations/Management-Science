...
#
# - *Fast Warehouse (Hamburg): Right next to our shipping hub. Orders ship
#   in 1-2 hours. But it’s small and has only 8,000 unit capacity.*
# - *Large Warehouse (Poland): Huge storage (50,000+ capacity) but orders
#   take 2-3 days to ship from there.*
#
# *The problem? We’re making terrible allocation decisions:*
#
# - *Slow-movers occupy 40% of fast warehouse space*
# - *Shipping delays costing us hundreds of thousands annually in customer
#   refunds*
...
#   (Poland warehouse)
# - **Black Friday:** Everyone expects fast delivery! High delay costs for
#   all SKUs.
#
...
# - **Demand Forecasting:**
#
#   - Forecast Black Friday 2025 demand (weeks 47-48 combined) for all 30
#     SKUs
...
#
#   - Generate 10,000 demand scenarios from your forecast with a variation
#     defined by you
...
#     vs. Poland
#   - Comparison to baseline (e.g., equal allocation across all SKUs, or
#     random)
#   - Cost savings in €€€
#
# > **Note**
...
# - Monte Carlo Risk Analysis: Report all important metrics (your choice)
...
#   warehouse ≤ 8,000!
# - **Poor visualization:** Make your allocation decision clear (how many
#   units of each SKU where?)
# - **No baseline comparison:** Always compare to a baseline (e.g., random
#   allocation) to show improvement
#
# ## Data Access
#
