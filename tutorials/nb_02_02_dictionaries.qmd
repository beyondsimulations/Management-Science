...
**Your Task:** Master **dictionaries** - Python's way of storing structured data with labels. Think of them as digital filing cabinets where everything has a clear label and is easy to find.
...
# Test the function
store = {"name": "Downtown", "monthly_sales": 120000, "customer_rating": 4.7}
...
2. Determine status: "Excellent" if margin > 30%, "Good" if > 20%, else "Needs Improvement"
3. Return a formatted string with the store name, margin, and status
