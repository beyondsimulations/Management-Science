...
5. **Minimum rest:** At least 11 hours between shifts
   - **No Evening→Morning** (same night transition: 23:00-07:00 = 8 hours rest ❌)
   - **No Night→Morning** (next day: ends 07:00, starts 07:00 = 0 hours rest ❌)
   - **No Night→Evening** (next day: ends 07:00, starts 15:00 = 8 hours rest ❌)
