...
::: {.callout-tip}
The function returns a dictionary. If you create a list of dictionaries and then use `pd.DataFrame` on that list, you will get a perfectly structured dataframe.
:::
...
for pair in pairs:
    ...
    portfolio_profit = profits_1 + profits_2
