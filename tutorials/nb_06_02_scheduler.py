...
#   station
# - **Cost pressures:**
#   - Overtime costs **€100/hour** for any work after Friday 19:00 (minute
#     780)
#   - Late delivery penalties ranging from **€50 to €150 per order**
#   - These are one time fees for missed deadlines, the bikes still have
#     to be completed till saturday morning as customers with missed
#     deadlines will collect them then
#
...
# - **Gantt Chart:** Visual showing your two-stage schedule (optional but
#   recommended)
# - **Cost Breakdown:** Overtime vs. penalties
# - **Strategy Justification:** 2-3 sentences explaining why your approach
#   works
#
# # Tips for Success
#
...
# - **Ignoring order types:** Rush orders have 3x the penalty of standard
#   orders!
#
# ## Final Checklist
#
