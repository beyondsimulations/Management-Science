...
# ## Company Background
#
# **TechVenture Innovation Fund** is a venture capital firm specializing
# in early-stage technology investments. Founded in 2018, the fund has
# successfully backed 23 startups with an average return of 32% per year.
# The partners pride themselves on data-driven decision making and
# sophisticated risk analysis.
#
# **Your Role:** You’ve been hired as consultants to analyze their latest
# investment opportunity.
#
# ## The Investment Opportunity
#
# TechVenture has **€2 million** available for immediate deployment. After
# extensive due diligence, they’ve narrowed their options to **four
# promising startups**. Due to diversification requirements and
# partnership agreements, they must invest in **exactly two startups**,
# allocating **€1 million to each**.
#
# ### The Four Candidates
#
# #### 1. CloudAI Solutions
...
# - **Competition:** Moderate (established players but room for
#   innovation)
...
# 4.  **Upside Potential:** Probability of exceptional returns (\>50%
#     total)
# 5.  **Worst-Case Scenario:** Expected shortfall in bottom 10% of
#     outcomes
#
...
# ## Your Mission
#
# Use Monte Carlo simulation to determine which pair of startups
# TechVenture should invest in. Your analysis should:
#
...
# - **Business Reasoning (25%):** Clear justification aligned with fund
#   goals
# - **Presentation (25%):** Clear, professional one-slide summary
#
# ## Time Limit
#
# You have until **next session** to complete your analysis and prepare
# your presentation.
#
...
# - **Visual:** One chart comparing the 6 portfolio options (optional but
#   recommended)
#
