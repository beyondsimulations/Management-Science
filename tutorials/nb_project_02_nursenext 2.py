...
# ## Meet Your Client
#
# **Industry:** Healthcare **Client Contact:** Dr. Robin Torres, Chief
# Operating Officer **Facility:** Medium-sized hospital with 3 departments
# **Staff:** 21 nurses, 50 beds, 24/7 operations
#
# ## The COO’s Challenge
#
...
#
# *The manual process is killing us. I try to be fair, but with 21 nurses,
...
# -   **Flexible Float Pool (8 nurses):** Cross-trained resource nurses
...
def generate_nurse_data():
    ...
    # Flexible Float Pool (8 nurses) - can work in ANY department
...
print(f"Available capacity (21 nurses × 6 shifts max): {21 * 6} shift-slots")
print(f"Capacity margin: {21 * 6 - total_shifts_needed} shift-slots")
...
# > **Deliverables**
# >
# > You must develop a scheduling solution that creates a one-week
# > schedule for all 21 nurses and provides:
# >
...
# >
# > -   **Problem understanding** (1 min): Dr. Torres’s challenges in your
# >     own words
# > -   **Your approach** (2 min): Algorithm choice, how you handled
# >     constraints and fairness
# > -   **Results** (3 min): Schedule visualization, cost savings,
# >     fairness metrics
# > -   **Business impact** (1 min): Recommendations for NurseNext,
# >     implementation plan
...
# >     days
# > 5.  **Minimum rest:** At least 11 hours between shifts (no
# >     Evening→Morning or Night→Morning/Evening)
...
# >         (check `departments_qualified` list)
...
#     -   Your own structure!
# 3.  **Fairness is subjective:** Define clear metrics for “fair”
#     distribution
# 4.  **Visualize the schedule:** A Gantt chart or heat map makes patterns
#     obvious
# 5.  **Labor laws are non-negotiable:** Zero violations if possible.
#     Check after every change!
# 6.  **Think like a nurse:** What makes a schedule “good” from their
#     perspective?
#     -   Predictable patterns
#     -   Fair weekend distribution
#     -   No excessive consecutive shifts
# 7.  **Overtime is expensive:** Keeping nurses under 40 hours saves
#     €100/shift!
#
...
#
# -   `nurses_df`: DataFrame with 21 nurses and their attributes
