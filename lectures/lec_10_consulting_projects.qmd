...
::: {.incremental}
- **100 meal deliveries** across Hamburg every day
...
- 100 delivery locations across Hamburg
- 4 drivers with capacity constraints (28 meals each)
...
::: {.incremental}
- **50 electronics SKUs:** Smartphones, laptops, ...
...
1. **Jupyter notebook** with complete solution
   - Well-commented code and clear explanations
