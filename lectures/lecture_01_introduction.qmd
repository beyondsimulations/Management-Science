...
- **Part III:** Consulting Competition (Lectures 10-12)
  - Real client briefings, team development, final presentations
:::

. . .

:::{.callout-important}
You're not just students. You're now **junior consultants** learning to solve real business problems!
:::
...
- You are [allowed to use AI]{.highlight} in the course, I use it as well (e.g., Claude, ChatGPT, Gemini - but please don't use Grok...)
...
- Open them and you are good to go!
