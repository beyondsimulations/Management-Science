...
[GitHub Copilot]{.highlight} is your AI pair programmer that helps you write code faster and with less effort.
...
::: callout-tip
There are alternative IDEs like Zed or Cursor for AI-Pair Programming, but you can use GitHub Copilot for free as student.
:::

## Have you used autocomplete before?
...
- **Learn patterns:** See how experienced programmers structure code
...
:::{.callout-tip}
Copilot is especially helpful when you know WHAT you want to do but forget HOW to do it in Python.
:::
...
[Rule: Always understand what Copilot suggests before accepting!]{.highlight}
...
**Step 1: Write a comment describing what you want**
...
[Watch how Copilot completes this in the IDE!]{.highlight}
...
:::{.callout-tip}
Notice how the comment guided Copilot to generate exactly what we needed!
:::

## What happens if you accept without reading?
...
- Practice writing these yourself first

. . .

**2. Skipping Problem-Solving**

- Don't let Copilot think for you
...
- Ask yourself: "Can I explain what this code does?"
- If no, either learn about it or write simpler code


## Tips for This Course I

[Throughout this course, use Copilot to:]{.highlight}

. . .

1. **Remember syntax** - "How do I filter a DataFrame again?"
2. **Generate visualization code** - "Create a bar chart of sales by month"
3. **Write function templates** - "Function to calculate distance between points"
4. **Debug syntax errors** - Copilot often suggests fixes for mistakes

## Tips for This Course II

[But please don't use it to:}{.highlight}[^iknow]

1. Skip the practice notebooks
2. Copy entire solutions without understanding
3. Avoid learning the fundamentals
4. Replace thinking about the problem

[^iknow]: I know that some of you won't follow this advice ;)
...
5. **Practice makes perfect** - The more you use it, the more helpful it becomes
