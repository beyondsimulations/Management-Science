...
axes[0].set_title('Original Sales Data (3 months)', fontweight='bold',fontsize=10)
axes[0].set_ylabel('Sales',fontsize=9)
axes[0].grid(True, alpha=0.2)

# Trend component
axes[1].plot(dates[:90], trend[:90], color=BRAND_COLORS["oneDark"], linewidth=2.5)
axes[1].set_title('Trend Component', fontweight='bold',fontsize=10)
axes[1].set_ylabel('Trend',fontsize=9)
axes[1].grid(True, alpha=0.2)

# Seasonal component
axes[2].plot(dates[:90], seasonal[:90], color=BRAND_COLORS["threeDark"], linewidth=1.5)
axes[2].set_title('Seasonal Component (Weekly Pattern)', fontweight='bold',fontsize=10)
axes[2].set_ylabel('Seasonality',fontsize=9)
axes[2].grid(True, alpha=0.2)

# Random component
axes[3].plot(dates[:90], noise[:90], color=BRAND_COLORS["twoLight"], linewidth=1, alpha=0.7)
axes[3].set_title('Random Component (Noise)', fontweight='bold',fontsize=10)
axes[3].set_ylabel('Noise',fontsize=9)
...
ax.set_title('Smoothing with Moving Averages', fontsize=10, fontweight='bold')
ax.legend()
ax.grid(True, alpha=0.2)
plt.tight_layout()
plt.show()
...
axes[0].set_title('Stable Sales', fontweight='bold',fontsize=10)
...
trend_es = SimpleExpSmoothing(trend_series).fit(smoothing_level=0.3,optimized=False)
...
axes[1].set_title('Growing Sales', fontweight='bold',fontsize=10)
axes[1].set_xlabel('Week',fontsize=9)
axes[1].set_ylabel('Sales',fontsize=9)
axes[1].legend()
axes[1].grid(True, alpha=0.2)
...
# Plot forecast
ax.plot(t_forecast, forecast_values, 'o-', color=BRAND_COLORS["threeDark"], linewidth=2.5, markersize=10, label='Forecast (Level + Trend)',
        alpha=0.8)
...
axes[0].set_title('Level', fontweight='bold', fontsize=10)
...
axes[2].set_title('Seasonality"', fontweight='bold', fontsize=10)
...
axes[0].set_title('Good Model: Captures Pattern', fontweight='bold', fontsize=10)
...
axes[1].set_title('Overfit Model: Memorizes Noise', fontweight='bold', fontsize=10)
...
ax.set_ylim(0, 1.5)
ax.set_xlabel('Months of Historical Data', fontsize=9)
ax.set_title('The Split: Never Mix Training and Test Data', fontsize=10, fontweight='bold')
ax.set_yticks([])
