...
#| eval: true
#| echo: false
# Show the problem again for furthest insertion
fig, ax = plt.subplots()
...
1. Start at the bakery
2. Find the furthest café from bakery - add it to tour
3. Create initial tour: Bakery → Furthest → Bakery
4. **Repeat:** Find the café furthest from current tour
...
ax1.set_title('1. Problem: Route Crosses Itself', fontsize=13, fontweight='bold')
...
ax3.set_title('3. Solution: No More Crossings!', fontsize=13, fontweight='bold')
