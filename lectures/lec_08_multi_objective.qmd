...
1. **Solve** multi-objective transportation (DCs → Zones)
2. **Select** optimal fleet mix (5 vehicle types)
3. **Balance** cost, emissions, service quality
4. **Meet** EU emission targets (40% reduction)
