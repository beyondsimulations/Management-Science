...
- Write clean, modular Python code (functions, control flow, data structures)
...
- Design and analyze scheduling solutions (SPT, EDD rules) with key performance metrics
- Solve routing problems using heuristics and local search improvements (nearest neighbor, 2-opt)
...
**Note:** This course is specifically designed for business students. No prior programming experience required—our teaching format supports different skill levels so every student can progress effectively.
...
| Date | Milestone |
|------|-----------|
| Lecture 1 | Course begins, teams formed |
| Lecture 4 | Mini-competitions begin |
| Lecture 8 | Assignment 1 due (Risk & Forecasting) |
| Lecture 10 | Assignment 2 due (Optimization Toolkit) |
| Lecture 10 | Client project teams formed |
| Lecture 12 | Final presentations (Consulting Finals) |
