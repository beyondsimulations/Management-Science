...
*Risk Analysis & Forecasting (Due at the start of Lecture 7, weight 30%)*
You’ll simulate investment outcomes to understand risk and then forecast demand using simple time-series techniques. Expect to implement Monte Carlo simulations, moving averages, and exponential smoothing, then compare methods and justify a recommendation. See details in assignment_01.qmd.

**Assignment 2:**

*Optimization in Practice (Due at the start of Lecture 10, weight 20%)*
You’ll build and improve delivery routes and construct valid staff schedules under constraints, then iterate to improve quality and satisfaction. Expect to implement heuristics, evaluate improvements, visualize routes/schedules, and discuss trade-offs. See details in assignment_02.qmd.

Work is in groups for both assignments. Typical time commitment is 3–5 hours for Assignment 1 and 4–5 hours for Assignment 2.
...
## Using AI Tools and Scientific Integrity
