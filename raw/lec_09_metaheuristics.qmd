...
## **[Client Briefing: La Étoile Restaurant]{.invert-font}** {background-image="https://unsplash.com/photos/Vd0_Htlb-Kk/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8Mjh8fHJlc3RhdXJhbnQlMjBtaWNoZWxpbnxlbnwwfHx8fDE3NjMyOTQ2OTR8MA&force=true&w=2400" background-size="cover"}

. . .

[Restaurant Manager's Crisis:]{.invert-font}

["We need to schedule [18 servers for this weekend]{.highlight}, but we don't have enough experienced staff to meet all quality requirements!"]{.invert-font .fragment}
...
[Question]{.question} How to minimize damage while maintaining service?
...
[The combinatorial explosion we're dealing with:]{.highlight}
...
ax.semilogy(shifts, possibilities, 'o-', color=BRAND_COLORS["oneDark"], linewidth=3, markersize=10)
ax.fill_between(shifts, 1, possibilities, alpha=0.3, color=BRAND_COLORS["oneLight"])
...
[Apply what you've learned to solve La Étoile's problem:]{.highlight}
...
[Your roadmap for the consulting competition:]{.highlight}
