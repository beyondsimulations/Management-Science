...
subtitle: Management Science - Retail Forecasting Competition
code-links:
  - text: Python
    href: nb_05_02_predictor.py
    icon: hand-thumbs-up
---
...
1.  **Accuracy (60%):** Mean Absolute Error (MAE) across all 12 forecasts
2.  **Business Logic (20%):** Reasonable patterns, seasonality considered
...
**Example:** If you forecast 1000 units but actual is 1200:
- Lost profit: 200 × €80 = €16,000 (for TechPod Pro)
...
<img src="nb_05_02_predictor_files/figure-markdown_strict/cell-3-output-2.png" width="1330" height="950" />
...
3.  **Consider Product Types:** Electronics vs. seasonal items behave differently
