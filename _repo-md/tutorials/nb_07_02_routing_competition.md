...
*"Every morning at 5 AM, our delivery van leaves with fresh bread for 16 cafés across the city. Our driver currently takes much too long using his 'intuition' for the route. The fuel costs are killing us, and worse, some cafés get their bread late.*
...
<img src="nb_07_02_routing_competition_files/figure-markdown_strict/cell-4-output-1.png" width="758" height="470" />
...
2.  **Initial Solution:** Your construction algorithm creates a starting route
3.  **Objective Function:** Total distance traveled (minimize this!)
4.  **Neighborhood:** How to create "nearby" solutions (2-opt swaps, Or-opt moves, etc.)
