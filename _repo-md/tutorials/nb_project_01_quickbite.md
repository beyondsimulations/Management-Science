...
```
    ...
    ================================================================================
     delivery_id       lat       lon        area requested_time window_start window_end  order_value
               ...
               9 53.552830 10.005464 city_center          19:14        19:00      19:29    54.015407
              10 53.545939  9.992114 city_center          18:06        18:00      18:21    50.522051

    ... and 110 more deliveries

    ================================================================================
    Total deliveries: 120
    Total order value: €4189.24
...
<img src="nb_project_01_quickbite_files/figure-markdown_strict/cell-3-output-1.png" width="759" height="470" />
