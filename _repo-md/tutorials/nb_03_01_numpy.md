...
Do the following **in the terminal** where you have all your notebooks as well as the files that `uv` added during its initialization. <span class="highlight">Not in the notebook!</span>
...
```
    ...
    Sample original prices: [23.64 14.45  6.62 12.86 15.66]

    After 15% increase + tax: [29.36 17.95  8.22 15.97 19.45]
    Total potential revenue: $8,211.70
