...
<img src="nb_05_01_time_series_files/figure-markdown_strict/cell-11-output-1.png" width="965" height="671" />
...
<img src="nb_05_01_time_series_files/figure-markdown_strict/cell-22-output-2.png" width="1333" height="757" />
...
```
    ...
    /var/folders/_5/jkkjxxdd5f1955l380dky7n80000gn/T/ipykernel_96595/3645223708.py:2: FutureWarning: 'M' is deprecated and will be removed in a future version, please use 'ME' instead.
      months = pd.date_range('2022-01-01', periods=24, freq='M')
...
> 3.  **Use Holt-Winters for seasonality** - If you see repeating patterns
>
> **Validation:**
>
> 1.  **Backtest first** - Test your method on last 4 weeks before the test period
